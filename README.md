...
A session-level governance layer for human-AI collaboration. Set constraints before the session starts. The AI cannot negotiate its own boundaries. Includes the [Diagnostic Vocabulary](https://github.com/richard-porter/frozen-kernel/blob/main/diagnostic-vocabulary.md) — a glossary of named AI failure modes and human vulnerability patterns.
...
The research home. Contains the Taller Shell Trilogy — a marine fantasy written through human-AI collaboration — plus the white paper documenting the origin event, escalation dynamics, governance intervention, and cross-model behavioral differentiation.
...
**If you’re curious about the whole thing** → Start with the [white paper](https://github.com/richard-porter/dimensional-authorship/blob/main/white-paper.md). It’s the documented story of one person figuring out how to work with AI without losing himself in the process.
